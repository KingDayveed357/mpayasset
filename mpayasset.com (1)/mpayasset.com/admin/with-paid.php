                ...
                <div class="col-6">
                  <div class="breadcrumb-sec">
                    <ul class="breadcrumb"> 
                      ...
                      <li class="breadcrumb-item">Manage Paid Request</li> 
                    </ul>
                  </div>
                </div>
              </div>
                      ...
                      <div class="table-responsive" style="min-height: 250px;">
                        <table class="table">
                          ...
                          <?php 
                            ...
                            $sql = runQuery("SELECT * FROM transactions dt JOIN users dr on dt.userid = dr.userid WHERE dt.transaction_type='debit'  AND dt.status='approved' ORDER BY dt.id DESC");
                            if(numRows($sql)>0){
                                $num=1;
